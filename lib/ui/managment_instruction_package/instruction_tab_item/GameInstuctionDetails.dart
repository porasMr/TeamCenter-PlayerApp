...
import 'package:team_center/ui/managment_instruction_package/InAppWebViewExampleScreen.dart';
...
class GameInstructionDetailsScreen extends StatefulWidget {
  GameInstructions? gameInstructions;
  GameInstructionDetailsScreen({this.gameInstructions});
  @override
  _GameInstructionDetailsScreenState createState() =>
      _GameInstructionDetailsScreenState();
}

class _GameInstructionDetailsScreenState
    extends State<GameInstructionDetailsScreen>
  ...
  void initState() {
    ...
    imagesList();
    fileList();
    ApiCall.readInstruction(widget.gameInstructions!.id.toString(),
        "game_instruction", this, context);
  }

  imagesList() {
    filePath = CommonMethod.stataData(widget.gameInstructions!.images!);
    print(filePath.length);
    setState(() {});
  }

  fileList() {
    fileDescription = CommonMethod.fileDesciptionData(
        widget.gameInstructions!.file_description!);
                          ...
                          children: [
                            ...
                            AppTextSize.textSize14(
                                CommonMethod.dateChangeRetrun(
                                    widget.gameInstructions!.updatedAt!),
                                AppColors.blackColor[500]!,
                                FontWeight.normal,
                                "rubikregular",
                                1),
                            ...
                            widget.gameInstructions!.description == "null"
                                ? Container()
                                : Html(
                                    data: widget.gameInstructions!.description!,
                                    customTextAlign: (_) =>

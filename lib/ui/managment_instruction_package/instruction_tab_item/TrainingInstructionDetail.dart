...
class TrainingInstructionDetailsScreen extends StatefulWidget {
  TrainingInstructions? traningInstructions;
  TrainingInstructionDetailsScreen({this.traningInstructions});
  @override
  _TrainingInstructionDetailsScreenState createState() =>
      _TrainingInstructionDetailsScreenState();
}

class _TrainingInstructionDetailsScreenState
    extends State<TrainingInstructionDetailsScreen>
  ...
  void initState() {
    ...
    imagesList();
    fileList();
    ApiCall.readInstruction(widget.traningInstructions!.id.toString(),
        "training_instruction", this, context);
  }

  imagesList() {
    filePath = CommonMethod.stataData(widget.traningInstructions!.images!);
  ...
  fileList() {
    fileDescription = CommonMethod.fileDesciptionData(
        widget.traningInstructions!.file_description!);
                        ...
                        child: ListView(
                          children: [
                            AppTextSize.textSize16(
                                widget.traningInstructions!.title!,
                            ...
                            AppTextSize.textSize14(
                                CommonMethod.dateChangeRetrun(
                                    widget.traningInstructions!.updatedAt!),
                                AppColors.blackColor[500]!,
                                FontWeight.normal,
                                "rubikregular",
                                1),
                            ...
                            widget.traningInstructions!.description == "null"
                                ? Container()
                                : Html(
                                    data: widget
                                        .traningInstructions!.description!,
                                    customTextAlign: (_) =>
